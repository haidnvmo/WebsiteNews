...
<form novalidate="novalidate" action="{{ route('customerpost.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ $editCustomerPost->title }}" placeholder="Nhap Title" name="title" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1"><b>Slug</b></label>
            <input type="text" value="{{ $editCustomerPost->slug }}" placeholder="Nhập Slug" name="slug" required>
        </div>
        <div class="form-group">
