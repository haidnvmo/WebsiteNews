...
<form novalidate="novalidate" action="{{ route('customerpost.create') }}" method="POST" enctype="multipart/form-data">
    ...
    @include('components.alert')
        ...
        <div class="form-group">
            ...
            <input type="text" onkeyup="ChangeToSlug()" id="title" placeholder="Nhap Title" name="title" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1"><b>Slug</b></label>
            <input type="text" id="slug" placeholder="Nhập Slug" name="slug" required>
        </div>
        <div class="form-group">
